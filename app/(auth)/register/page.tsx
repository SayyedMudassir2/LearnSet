...
export default function RegisterPage() {
  ...
  // --- Handler for Step 2: Verify OTP & Register ---
      ...
      <Card className="w-full max-w-md mx-4">
        ...
        {step === 1 && (
          <>
            <CardHeader>
              ...
              <CardDescription>Enter your details to get started. We'll send an OTP to your email.</CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...form}>
        ...
        {step === 2 && (
           ...
           <CardHeader>
             ...
             <CardDescription>Enter the 6-digit OTP sent to <strong>{formData?.email}</strong>.</CardDescription>
           </CardHeader>
           <CardContent>
             <Form {...otpForm}>
